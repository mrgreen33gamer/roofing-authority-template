...
const SERVICES = [
  { icon: faHouseChimney,       label: 'Roof Replacement' },
  { icon: faHammer,             label: 'Roof Repair' },
  { icon: faCloudShowersHeavy,  label: 'Storm Damage Restoration' },
  { icon: faMagnifyingGlass,    label: 'Roof Inspection' },
  { icon: faDroplet,            label: 'Gutter Installation' },
  { icon: faBuilding,           label: 'Commercial Roofing' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'GAF Master Elite®' },
  { icon: faStar,         text: '4.9★ · 400+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A licensed Ironclad Roofing crew member will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+15129006200"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (512) 900-6200', section: 'ContactForm-V1' })}>
                          Call (512) 900-6200
                        </a>
                      </span>
                    </div>

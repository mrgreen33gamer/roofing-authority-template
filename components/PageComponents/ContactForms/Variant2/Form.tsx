...
import {
  ...
  faHouseChimney, faHammer, faCloudShowersHeavy, faMagnifyingGlass,
  faDroplet, faBuilding,
        ...
        <div className={styles.card}>
          ...
          <div className={styles.leftPanel}>
            <div className={styles.panelInner}>
              ...
              <span className={styles.quoteAttrib}>— Ironclad Roofing Co., Georgetown TX</span>

              <div className={styles.panelStats}>
                {[
                  { val: '2,400+', lbl: 'Roofs Restored' },
              ...
              <div className={styles.panelBadges}>
                {['Same-Day Available', '25-Year Warranty', 'No Contracts', 'GAF Master Elite®'].map(b => (

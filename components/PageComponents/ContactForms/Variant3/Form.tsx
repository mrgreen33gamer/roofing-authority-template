...
const FIELDS = [
  ...
  { num: '02', id: 'v3-phone',   name: 'phone',   type: 'tel',   label: 'Phone Number',  icon: faPhone,       placeholder: '(512) 555-0100',        required: true  },
  { num: '03', id: 'v3-email',   name: 'email',   type: 'email', label: 'Email Address', icon: faEnvelope,    placeholder: 'jane@example.com',       required: true  },
  { num: '04', id: 'v3-address', name: 'address', type: 'text',  label: 'Service Address',icon: faLocationDot, placeholder: '123 Main St, Georgetown TX', required: false },
];
                ...
                <motion.div className={styles.numberedField}
                  ...
                  <div className={styles.fieldInner}>
                    ...
                    <textarea id="v3-message" name="message" className={`${styles.input} ${styles.textarea}`}
                      placeholder="What's happening? Missing shingles? Active leak? Storm or hail damage?" rows={3}

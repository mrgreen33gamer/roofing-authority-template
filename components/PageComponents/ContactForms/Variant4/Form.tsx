...
import {
  ...
  faHouseChimney, faHammer, faCloudShowersHeavy, faMagnifyingGlass, faDroplet, faBuilding,
...
const SERVICES = [
  { icon: faHouseChimney,      label: 'Roof Replacement',          sub: 'Full tear-off & new roof system' },
  { icon: faHammer,            label: 'Roof Repair',                sub: 'Leaks, missing shingles, damage' },
  { icon: faCloudShowersHeavy, label: 'Storm Damage Restoration',   sub: 'Hail, wind, or storm damage' },
  { icon: faMagnifyingGlass,   label: 'Roof Inspection',            sub: 'Free inspection & condition report' },
  { icon: faDroplet,           label: 'Gutter Installation',        sub: 'New gutters or gutter repair' },
  { icon: faBuilding,          label: 'Commercial Roofing',         sub: 'Flat roofs, multi-unit, retail' },
];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A licensed Ironclad Roofing crew member will reach out about your <strong>{selectedService}</strong> service.
                  </p>

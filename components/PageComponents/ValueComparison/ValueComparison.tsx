...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: '25-Year workmanship warranty',           us: true,  others: false },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'Ironclad vs. The Other Guys' }: ValueComparisonProps) {
  return (

...
export default function CTABanner({
  ...
  subline   = "Same-day inspections available. Flat-rate pricing — no hidden fees. Call now or grab a free estimate online.",
      ...
      <div className={styles.inner}>
        ...
        >
          <span className={styles.eyebrow}>
            ...
            Central Texas Roofing Experts Since 2010
          </span>

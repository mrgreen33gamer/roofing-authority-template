...
const DEFAULT_GUARANTEES: Guarantee[] = [
  ...
  },
  {
    ...
    description:
      "Every roof we install is covered for 25 years — materials and labor. If something fails, we fix it at no charge.",
  },
  {
    icon: faRotateLeft,
  ...
  },
  {
    ...
    description:
      "Every crew lead on your roof is GAF Master Elite®-certified and fully insured. No subcontractor gambles — ever.",
  },
  {
      ...
      <div className={styles.container}>
        ...
        <div className={styles.leftCol}>
          ...
          <p className={styles.body}>
            Every roofing company in Central Texas makes promises. We back ours in writing — with flat-rate pricing, GAF Master Elite®-certified crews, and a 25-year warranty on every roof we touch.
          </p>
          <Link
            href={ctaLink}
          ...
          <div className={styles.ratingRow}>
            ...
            <span className={styles.ratingText}>4.9 · 400+ verified Google reviews</span>
          </div>
        </div>

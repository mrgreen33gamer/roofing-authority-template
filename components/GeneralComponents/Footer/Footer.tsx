...
import {
  ...
  faShieldHalved, faWrench, faClock, faHouseChimney,
...
const LOCAL_AREAS = [
  'Georgetown, TX', 'Round Rock, TX', 'Cedar Park, TX',
  'Leander, TX', 'Liberty Hill, TX', 'Hutto, TX',
  'Taylor, TX', 'Jarrell, TX',
];

const TRUST_ITEMS = [
  { icon: faShieldHalved,   label: 'Licensed & Insured' },
  { icon: faWrench,         label: 'GAF Master Elite® Certified' },
  { icon: faClock,          label: 'Same-Day Service' },
  { icon: faHouseChimney,   label: '25-Yr Warranty' },
];

const SOCIALS = [
  { href: 'https://facebook.com/ironcladroofingco', icon: faFacebookF, label: 'Facebook' },
  { href: 'https://g.page/r/ironcladroofingco',      icon: faGoogle,    label: 'Google' },
];
          ...
          <div className={styles.brandCol}>
            <Link href="/" className={styles.logo}>
              ...
              <div className={styles.logoText}>
                <span className={styles.logoName}>Ironclad Roofing Co.</span>
                <span className={styles.logoSub}>Georgetown, Texas</span>
              </div>
            </Link>
      ...
      <div className={styles.bottomBar}>
        <div className={styles.bottomInner}>
          <p className={styles.copyright}>
            &copy; {new Date().getFullYear()} Ironclad Roofing Co. All Rights Reserved. | Fully Insured & Bonded
          </p>
          <a href="tel:+15129006200" className={styles.emergencyBtn}

...
// Ironclad Roofing Co. — Contact Page (unique build, not just a form import)
...
const SERVICES = [
  ...
  'Roof Inspection', 'Gutter Installation', 'Commercial Roofing',
...
const faq = [
  {
    ...
    answer: "Call us directly at (512) 900-6200. We answer 7 days a week including evenings. For active roof leaks or storm damage in Central Texas, call — don't wait on a form response.",
  },
  {
    question: 'How quickly can someone come out?',
    answer: "Same-day inspections are available most days during business hours. Evening and weekend emergency calls are dispatched within 1–2 hours. We'll give you an honest ETA when you call — not a 4-hour window.",
  },
  {
    question: 'Do you charge for the inspection?',
    answer: 'Standard roof inspections are free, no obligation. If you\'re filing an insurance claim after storm damage, we\'ll document everything your adjuster needs at no cost either way.',
  },
  {
    question: 'Do you work on commercial roofing systems?',
    answer: 'Yes — commercial roofing for retail centers, offices, HOAs, and multi-family properties is within our scope. Call to discuss your specific building and timeline.',
  },
  {
    question: 'What areas do you serve?',
    answer: 'Georgetown, Round Rock, Cedar Park, Leander, Liberty Hill, Hutto, Taylor, Jarrell, and most of Central Texas within about 60 miles of Georgetown. Call us — we probably cover your area.',
  },
  {
    question: 'How do I know if I need a repair or a full replacement?',
    answer: "Our crew lead will tell you honestly after the inspection. If your roof is under 10 years old and the damage is isolated, we'll usually recommend a repair — but we'll always show you the photos and let you decide.",
  },
];
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch('/api/submitContact', {
        ...
        body: JSON.stringify({
          ...formData, urgent, cityName: 'Georgetown', slug: 'contact',
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          <motion.div className={styles.heroBadge}
            ...
            Available 7 Days — Evenings &amp; Storm Emergencies Included
          </motion.div>
          <motion.h1 className={styles.heroTitle}
            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: 0.08 }}>
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>Roof Fixed</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@ironcladroofingtx.com',
                  href:      'mailto:hello@ironcladroofingtx.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '1420 Rivery Blvd, Georgetown TX 78628',
                  href:      'https://maps.google.com/?q=1420+Rivery+Blvd+Georgetown+TX+78628',
                ...
                },
                {
                  ...
                  label:     'Hours',
                  value:     'Mon–Fri 7am–6pm · Sat 8am–2pm · Storm Emergency 24/7',
                  href:      null,
                  eventType: null,
                  eventLabel: null,
                },
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose Ironclad</p>
              {[
                'Flat-rate pricing — written estimate before we start',
                '25-year workmanship warranty on every roof',
                'GAF Master Elite®-certified crews only',
                'Free inspections, 7 days a week',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A certified Ironclad crew lead will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+15129006200">(512) 900-6200</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <div className={styles.formCardHeader}>
                    ...
                    <div>
                      <h2 className={styles.formTitle}>Request an Inspection or Free Estimate</h2>
                  ...
                  >
                    ...
                    {urgent
                      ...
                      : 'Mark as urgent or storm emergency'}
                  </button>
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.row}>
                      ...
                      <div className={styles.field}>
                        ...
                        <input id="c-phone" className={styles.input} name="phone" type="tel"
                          placeholder="(512) 555-0100" required value={formData.phone} onChange={handleChange} />
                      </div>
                    </div>
                    ...
                    <div className={styles.field}>
                      ...
                      <input id="c-address" className={styles.input} name="address" type="text"
                        placeholder="123 Main St, Georgetown TX" value={formData.address} onChange={handleChange} />
                    </div>
                    ...
                    <div className={styles.field}>
                      ...
                      <textarea id="c-message" className={`${styles.input} ${styles.textarea}`}
                        ...
                        placeholder="What's happening? Leak, missing shingles, storm damage? When did you notice it?"
      ...
      <div className={styles.faqWrap}>
        <FAQ cityName="Georgetown" faq={faq} title="Common Questions Before You Call" />
      </div>

      {/* ── CTA Banner ───────────────────────────────────────────────────── */}
      <CTABanner
        headline="Need Us Right Now?"
        subline="Call (512) 900-6200 — we answer 7 days a week, evenings included. Storm emergency service available across Central Texas."
        primaryText="Call (512) 900-6200"
        primaryLink="tel:+15129006200"
        secondaryText="Send a Text"
        secondaryLink="sms:+15129006200"
      />

...
const slug     = 'metal-vs-shingle-roofing-central-texas';
const post     = getPostBySlug(slug)!;
const url      = `${BASE_URL}/blogs/${slug}`;
const imgUrl   = `${BASE_URL}/pages/blogs/metal-vs-shingle-roofing.jpg`;

export const metadata: Metadata = {
  title: `${post.title} | Ironclad Roofing Co.`,
  description: post.excerpt,
  keywords: ['metal vs shingle roof texas', 'metal roofing georgetown tx', 'roofing materials central texas', 'best roofing material for texas'],
...
const articleSchema = {
  ...
  keywords: 'metal vs shingle roof texas, metal roofing georgetown tx',

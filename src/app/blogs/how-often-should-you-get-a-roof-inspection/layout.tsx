...
const slug     = 'how-often-should-you-get-a-roof-inspection';
const post     = getPostBySlug(slug)!;
const url      = `${BASE_URL}/blogs/${slug}`;
const imgUrl   = `${BASE_URL}/pages/blogs/roof-inspection-schedule.jpg`;

export const metadata: Metadata = {
  title: `${post.title} | Ironclad Roofing Co.`,
  description: post.excerpt,
  keywords: ['roof inspection frequency', 'how often roof inspection central texas', 'roof maintenance georgetown', 'roof inspection georgetown tx'],
...
const articleSchema = {
  ...
  keywords: 'roof inspection frequency, roof maintenance central texas',
